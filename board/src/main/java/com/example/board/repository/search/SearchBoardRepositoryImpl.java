...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository {
    ...
    public Board search1() {
        ...
        JPQLQuery<Tuple> tuple = jpqlQuery.select(board.bno,board.title,board.regDate,member.name, member.email, reply.count());
        tuple.groupBy(board.bno,board.title,board.regDate,member.name, member.email);
